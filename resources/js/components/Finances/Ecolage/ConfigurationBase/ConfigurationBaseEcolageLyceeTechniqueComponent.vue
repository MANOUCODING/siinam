    ...
    <div class="main-content container-fluid p-0">
      <div class="email-head">
          <div class="email-head-subject">
              ...
              <div class="icons"><router-link to="/finances/ecolage" class="btn btn-lg btn-primary btn-block icon" style="color: #fff"><i class="fas fa-dollar-sign"></i> &nbsp; &nbsp;Payer les frais</router-link>
                </div>
              </div>
          </div>
      </div>
          ...
          <div class="col-lg-12">
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                  <router-link to="/finances/ecolage/settings/college">
                    <div class="card">
                      <div class="card-body">
                ...
                <!-- ============================================================== -->
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                  <router-link to="/finances/ecolage/settings/lycee/moderne">
                    <div class="card">
                      <div class="card-body">
                          <div class="d-inline-block">
                ...
                <!-- ============================================================== -->
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                  <router-link to="/finances/ecolage/settings/lycee/technique">
                    <div class="card">
                      <div class="card-body">
                          <div class="d-inline-block">
