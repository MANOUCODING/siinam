    ...
    <div class="main-content container-fluid p-0">
      <div class="email-head">
          <div class="email-head-subject">
              <div class="title"><a class="active" href="#"><span class="icon"><i class="fas fa-2x fa-users"></i></span></a>   <span>Configuration des absences</span>
              <div class="icons"><router-link to="/absences/signaler" class="btn btn-lg btn-primary btn-block icon" style="color: #fff"><i class="fas fa-2x fa-plus"></i> &nbsp; &nbsp;Signaler une absence</router-link>
                </div>
              </div>
          </div>
      </div>
      <div class="email-body">
        ...
        <div class="row" >
          ...
          <!-- ============================================================== -->
          <div class="col-lg-12">
            <div class="section-block"> <h3>Configuration de base pour le lycée technique</h3></div>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                  <router-link to="/absences/settings/college">
                    <div class="card">
                      <div class="card-body">
                ...
                <!-- ============================================================== -->
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                  <router-link to="/absences/settings/lycee/moderne">
                    <div class="card">
                      <div class="card-body">
                          <div class="d-inline-block">
                ...
                <!-- ============================================================== -->
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                  <router-link to="/absences/settings/lycee/technique">
                    <div class="card">
                      <div class="card-body">
                          <div class="d-inline-block">
