    ...
    <div class="main-content container-fluid p-0">
      <div class="email-head">
          <div class="email-head-subject">
              <div class="title"><a class="active" href="#"><span class="icon"><i class="fas fa-2x fa-users"></i></span></a>   <span>Etat des absences</span>
      ...
      <div class="email-body">
        ...
        <div class="row" >
          ...
          <!-- ============================================================== -->
          <div class="col-lg-12">
            <div class="section-block"> <h3>Etat des absences pour le lycée technique</h3></div>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                  <router-link to="/etat/absences/college">
                    <div class="card">
                      <div class="card-body">
                ...
                <!-- ============================================================== -->
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                  <router-link to="/etat/absences/lycee/moderne">
                    <div class="card">
                      <div class="card-body">
                          <div class="d-inline-block">
                ...
                <!-- ============================================================== -->
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                  <router-link to="/etat/absences/lycee/technique">
                    <div class="card">
                      <div class="card-body">
                          <div class="d-inline-block">
          ...
          <div class="col-xl-12 col-lg-6 col-md-12 col-sm-12 col-12">
              <div class="card">
                  <h5 class="card-header">Etat des absences pour le lycée technique</h5>
