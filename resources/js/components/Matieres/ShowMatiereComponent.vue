        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h3 class="mb-2">Les Affectations sur Matière</h3>
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Gestion des matieres</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Les Affectations</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="col-xl-4 col-lg-3 col-md-6 col-sm-12 col-12">
                        <router-link :to="{ name: 'settings.users.show.connexions', params: { id: 1 }}" >
                            <div class="card border-3 border-top border-top-primary">
                                <div class="card-body">
                                    <h5 class="text-muted">Les Affectations</h5>
