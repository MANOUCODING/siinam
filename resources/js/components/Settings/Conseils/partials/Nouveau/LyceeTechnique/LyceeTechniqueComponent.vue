    ...
    <div class="main-content container-fluid p-0">
      ...
      <div class="email-body">
        ...
        <div class="row" >
          ...
          <!-- ============================================================== -->
          <div class="col-lg-12">
            <div class="section-block"> <h3>Decisions pour les nouveaux</h3></div>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                  <router-link to="/settings/decisions/nouveaux/colleges">
                    <div class="card">
                      <div class="card-body">
                ...
                <!-- ============================================================== -->
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                  <router-link to="/settings/decisions/nouveaux/lyceemoderne">
                    <div class="card">
                      <div class="card-body">
                          <div class="d-inline-block">
                ...
                <!-- ============================================================== -->
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                  <router-link to="/settings/decisions/nouveaux/lyceetechnique">
                    <div class="card">
                      <div class="card-body">
                          <div class="d-inline-block">
                          ...
                          <tbody v-for="info in infos.infosLyceeTechnique" :key="info">
                              <tr>
                                  ...
                                  <td v-if="info.nbreDecision == 0">
                                    <router-link :to="{ name: 'settings.decisions.conseils.show.nouveaux', params: { id: info.id }}" class="btn btn-xs btn-rounded btn-primary">
                                     Pas décisions
                                    </router-link> 
                                  </td>
                                  <td v-else>
...
export default {
  ...
  methods:{
    getResults(){
      axios
        .get('/api/settings/decisions/conseils/nouveaux')
        .then(response => {
   ...
   deleteDecisionConseilAll(id) {
      this.$swal({
        ...
        if (confirmed.isConfirmed) {
          axios
          .delete(`/api/settings/decisions/conseils/${id}/destroyAll/nouveaux`)
          .then(response => {
              this.getResults();
