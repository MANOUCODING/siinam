      ...
      <div class="email-head">
          <div class="email-head-subject">
              <div class="title"><a class="active" href="#"><span class="icon"><i class="fas fa-2x fa-cog"></i></span></a> <span>Décision pour les nouveaux</span>
                  <div class="icons" ><router-link v-if="emptyF == 0 " :to='{name:"settings.decisions.conseils.show.nouveaux", params: { id: infos.classe.id }}' class="btn btn-lg btn-primary btn-block icon" style="color: #fff"><i class="fas fa-bars"></i> &nbsp; &nbsp;Liste des decisions</router-link></div>
              </div>
          </div>
      </div>
