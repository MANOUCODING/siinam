    ...
    <div class="main-content container-fluid p-0">
      <div class="email-head">
          <div class="email-head-subject">
              <div class="title"><a class="active" href="#"><span class="icon"><i class="fas fa-2x fa-cog"></i></span></a> <span>Décisions por les doublants</span>
                  <div class="icons" ><router-link v-if="emptyF == 0 " :to='{name:"settings.decisions.conseils.show.doublants", params: { id: infos.classe.id }}' class="btn btn-lg btn-primary btn-block icon" style="color: #fff"><i class="fas fa-bars"></i> &nbsp; &nbsp;Liste des décisions</router-link></div>
              </div>
          </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    edit(){
      ...
      axios
        .get(`/api/settings/decisions/conseils/doublants/${this.$route.params.id}/show/${this.$route.params.decision_id}/edit`)
        .then(response => {
