    ...
    <div class="main-content container-fluid p-0">
      <div class="email-head">
          <div class="email-head-subject">
              <div class="title"><a class="active" href="#"><span class="icon"><i class="fas fa-2x fa-cog"></i></span></a> <span>Décision pour les nouveaux</span>
                  <div class="icons" ><router-link v-if="emptyF == 0 " :to='{name:"settings.decisions.conseils.show.doublants", params: { id: infos.classe.id }}' class="btn btn-lg btn-primary btn-block icon" style="color: #fff"><i class="fas fa-bars"></i> &nbsp; &nbsp;Liste des decisions</router-link></div>
              </div>
          </div>
      </div>
      <div class="email-body">
        <div class="row" >
          ...
          <!-- ============================================================== -->
          <div class="col-lg-12">
              <div class="section-block"> <h3> Ajouter une  décision</h3>
              </div>
              <div class="card">
                  ...
                  <form class="container">
                    <div class="row">
                      ...
                      <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="form-group" v-if="!errors.detailsDecision">
                          <label for="inputText3" class="col-form-label">Détails sur la décision</label>
                    ...
                    <div class="modal-footer"  v-if="emptyF == 0 ">
                      <router-link :to='{name:"settings.decisions.conseils.show.doublants", params: { id: infos.classe.id }}' class="btn btn-secondary" >Retour</router-link>
                        <button  v-if="loadingSave" class="btn  btn-primary"  type="button">
                            Enregistrement en cours ....
                        </button>
                        <button type="submit" v-if="!loadingSave" class="btn btn-primary" @click.prevent="store">
                          Enregistrez
                        </button>
...
export default {
  ...
  methods: {
    store(){
      ...
      axios.post(`/api/settings/decisions/conseils/${this.$route.params.id}/store`, this.data)
      .then(response => {
          ...
          this.$router.push({name:"settings.decisions.conseils.show.doublants", params: { id: this.infos.classe.id }})
          } else {
    ...
    create(){
      ...
      axios
        .get(`/api/settings/decisions/conseils/doublants/${this.$route.params.id}/show`)
        .then(response => {
