    ...
    <div class="main-content container-fluid p-0">
      <div class="email-head">
          <div class="email-head-subject">
              <div class="title"><a class="active" href="#"><span class="icon"><i class="fas fa-2x fa-cog"></i></span></a>   <span>Décision du conseil pour les doublants</span>
              </div>
          </div>
      </div>
             ...
             <div class="row">
              ...
              <div class="col-xl-12 col-lg-6 col-md-12 col-sm-12 col-12">
                  ...
                  <h5 class="card-header">Liste des decisions</h5>
                   <div>
                        <router-link style="float: right; margin-top: -45px; margin-right: 17px" v-if="emptyF == 0 " :to='{name:"settings.decisions.conseils.create.doublants", params: { id: infos.classe.id }}' class="btn btn-rounded btn-primary"><i class="fa fa-plus"></i>Ajouter une décision</router-link>
                    </div>
                                  ...
                                  <th scope="row">{{ info.id  }}</th>
                                    ...
                                    <td>
                                      <div class="row" style="max-width: 100%" >
                                          ...
                                          <div class="col-md-3">
                                            <router-link :to="{ name: 'settings.decisions.conseils.update.doublants', params: { id: info.classe_id, decision_id: info.id  }}" class="btn btn-xs btn-rounded btn-primary">
