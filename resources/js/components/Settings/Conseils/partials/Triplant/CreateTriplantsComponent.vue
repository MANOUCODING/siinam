    ...
    <div class="main-content container-fluid p-0">
      <div class="email-head">
          <div class="email-head-subject">
              <div class="title"><a class="active" href="#"><span class="icon"><i class="fas fa-2x fa-cog"></i></span></a> <span>Décision pour les triplants</span>
                  <div class="icons" ><router-link v-if="emptyF == 0 " :to='{name:"settings.decisions.conseils.show.triplants", params: { id: infos.classe.id }}' class="btn btn-lg btn-primary btn-block icon" style="color: #fff"><i class="fas fa-bars"></i> &nbsp; &nbsp;Liste des decisions</router-link></div>
              </div>
          </div>
      </div>
  ...
  methods: {
    store(){
      ...
      .then(response => {
          ...
          this.$router.push({name:"settings.decisions.conseils.show.triplants", params: { id: this.infos.classe.id }})
          } else {
    ...
    create(){
      ...
      axios
        .get(`/api/settings/decisions/conseils/triplants/${this.$route.params.id}/show`)
        .then(response => {
