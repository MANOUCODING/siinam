    ...
    <div class="main-content container-fluid p-0">
      ...
      <div class="email-body">
        ...
        <div class="row" >
          ...
          <!-- ============================================================== -->
          <div class="col-lg-12">
            <div class="section-block"> <h3>Decisions pour les triplants</h3></div>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                  <router-link to="/settings/decisions/triplants/colleges">
                    <div class="card">
                      <div class="card-body">
                ...
                <!-- ============================================================== -->
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                  <router-link to="/settings/decisions/triplants/lyceemoderne">
                    <div class="card">
                      <div class="card-body">
                          <div class="d-inline-block">
                ...
                <!-- ============================================================== -->
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                  <router-link to="/settings/decisions/triplants/lyceetechnique">
                    <div class="card">
                      <div class="card-body">
                          <div class="d-inline-block">
