    ...
    <div class="main-content container-fluid p-0">
      <div class="email-head">
          <div class="email-head-subject">
              <div class="title"><a class="active" href="#"><span class="icon"><i class="fas fa-2x fa-cog"></i></span></a> <span>Appréciation par Semestres</span>
                  <div class="icons" ><router-link v-if="emptyF == 0 " :to='{name:"settings.appreciations.semestres.show", params: { id: infos.classe.id }}' class="btn btn-lg btn-primary btn-block icon" style="color: #fff"><i class="fas fa-bars"></i> &nbsp; &nbsp;Liste des appréciations</router-link></div>
              </div>
          </div>
      </div>
      <div class="email-body">
        <div class="row" >
          ...
          <!-- ============================================================== -->
          <div class="col-lg-12">
              <div class="section-block"> <h3> Modifier une  appréciation</h3>
              </div>
              <div class="card">
...
export default {
  ...
  methods: {
    update(){
      ...
      axios.put(`/api/settings/appreciations/semestres/${this.$route.params.id}/show/${this.$route.params.appreciation_id}/update`, this.data)
      .then(response => {
          ...
          this.$router.push({name:"settings.appreciations.semestres.show", params: { id: this.infos.classe.id }})
          } else {
    ...
    edit(){
      ...
      axios
        .get(`/api/settings/appreciations/semestres/${this.$route.params.id}/show/${this.$route.params.appreciation_id}/edit`)
        .then(response => {
          if(response.status == 200){
            if (response.data.success == false) {
              ...
              if (response.data.message == 'Aucune classe trouvée.') {
                ...
                this.empty = 0
                this.infos = response.data
                this.data = response.data.appreciationSemestre
