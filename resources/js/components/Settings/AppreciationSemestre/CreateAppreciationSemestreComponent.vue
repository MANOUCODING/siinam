...
export default {
  ...
  methods: {
    store(){
      ...
      axios.post(`/api/settings/appreciations/semestres/${this.$route.params.id}/store`, this.data)
      .then(response => {
    ...
    create(){
      ...
      axios
        .get(`/api/settings/appreciations/semestres/${this.$route.params.id}/create`)
        .then(response => {
