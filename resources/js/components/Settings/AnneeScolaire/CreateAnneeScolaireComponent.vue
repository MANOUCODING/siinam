              ...
              <div class="card">
                  <div class="card-body">
                    ...
                    <form>
                      ...
                      <hr>
                      <h4 v-if="data.typePeriodeBoolean">Definir les dates de vos trois trimestres </h4>
                      <h4 v-else>Definir les dates de vos deux semestres </h4>
                      <div  v-if="data.typePeriodeBoolean">
