    ...
    <div class="container-fluid dashboard-content">
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h3 class="mb-2">Les élèves du lycée moderne</h3>
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Gestion des élèves</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Liste de toutes les élèves du lycée moderne</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="row">
          ...
          <div class="col-xl-12 col-lg-6 col-md-12 col-sm-12 col-12">
              <div class="card">
                  <h5 class="card-header">Les éleves du lycée moderne</h5>
