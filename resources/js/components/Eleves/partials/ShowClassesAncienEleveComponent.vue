    ...
    <div class="container-fluid dashboard-content">
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h3 class="mb-2">Tous les anciens élèves <span v-if="emptyC === 0">de la classe de {{ infos.classe.codeClasse }} </span></h3>
        ...
        <div class="row">
          ...
          <div class="col-xl-12 col-lg-6 col-md-12 col-sm-12 col-12">
              <div class="card">
                  <h5 class="card-header">Tous les anciens élèves <span v-if="emptyC === 0">de la classe de {{ infos.classe.codeClasse }}</span></h5>
                  <div v-if="emptyC === 0">
                  ...
                  <div class="card-body" v-if="empty === 0">
                      <table class="table table-bordered">
                          ...
                          <tbody v-for="info in infos.infosAnciens" :key="info">
