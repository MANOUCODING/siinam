          ...
          <div class="col-xl-12 col-lg-6 col-md-12 col-sm-12 col-12">
              <div class="card">
                  <h5 class="card-header">Liste des classes du lycée technique</h5>
                    <div>
                        <router-link style="float: right; margin-top: -45px; margin-right: 17px" :to='{name:"CreateClasseLyceeTechniqueComponent"}' class="btn btn-rounded btn-primary"><i class="fa fa-plus"></i>Ajouter une Classe</router-link>
                    </div>
                              ...
                              <tr>
                                  ...
                                  <td>
                                    <div class="row" style="max-width: 100%" >
                                        <div class="col-md-4">
                                          <router-link :to="{ name:'UpdateClasseLyceeTechniqueComponent', params: { id: info.id }}" class="btn btn-rounded btn-primary">
